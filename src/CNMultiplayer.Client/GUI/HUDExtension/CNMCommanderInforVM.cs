...
{
    public class CNMCommanderInforVM : ViewModel
    {
        private readonly MissionMultiplayerGameModeBaseClient _gameMode;
        private readonly CNMSiegeClient _siegeClient;
        ...
        public CNMCommanderInforVM()
        {
            ...
            _siegeClient = Mission.Current.GetMissionBehavior<CNMSiegeClient>();
