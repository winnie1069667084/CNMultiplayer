...
{
    internal class CNMHUDExtensionVM : ViewModel
    {
        ...
        private CNMCommanderInforVM _commanderInfo;
        ...
        public CNMHUDExtensionVM(Mission mission)
        {
            _mission = mission;
        ...
        [DataSourceProperty]
        public CNMCommanderInforVM CommanderInfo
        {
            get
            {
        ...
        private void OnPeerComponentAdded(PeerComponent component)
        {
            ...
            _isTeammateAndEnemiesRelevant =
                ...
                && !_mission.HasMissionBehavior<CNMSiegeClient>()
                && _gameMode.GameType != MultiplayerGameType.Battle;
            CommanderInfo = new CNMCommanderInforVM();
            ShowCommanderInfo = !_mission.HasMissionBehavior<MissionMultiplayerTeamDeathmatchClient>(); //指定某个模式不开启指挥官信息
            if (_isTeammateAndEnemiesRelevant)
            {
                OnRefreshTeamMembers();
                OnRefreshEnemyMembers();
